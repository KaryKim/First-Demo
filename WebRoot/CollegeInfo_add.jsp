...
<TABLE align="center" height="100%" cellSpacing=0 cellPadding=0 width="80%" border=0>
  ...
  <TR>
    ...
    <s:form action="CollegeInfo/CollegeInfo_AddCollegeInfo.action" method="post" id="collegeInfoAddForm" onsubmit="returncheckForm();"  enctype="multipart/form-data" name="form1">
