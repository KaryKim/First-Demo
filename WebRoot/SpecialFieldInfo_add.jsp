...
<TABLE align="center" height="100%" cellSpacing=0 cellPadding=0 width="80%" border=0>
  ...
  <TR>
    ...
    <s:form action="SpecialFieldInfo/SpecialFieldInfo_AddSpecialFieldInfo.action" method="post" id="specialFieldInfoAddForm" onsubmit="returncheckForm();"  enctype="multipart/form-data" name="form1">
